...
class V1n2Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return V1n2Entity(self._client, opts)
    ...
    def load(self, reqmatch=None, ctrl=None) -> V1n2:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.V1n2().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
