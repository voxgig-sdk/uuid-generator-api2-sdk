...
class TestV1nDirect:
    ...
    def test_should_direct_list_v1n(self):
        setup = _v1n_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-v1n", "live" if setup["live"] else "unit")
        if _skip:
