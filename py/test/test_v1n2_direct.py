...
class TestV1n2Direct:

    def test_should_direct_load_v1n2(self):
        setup = _v1n2_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-v1n2", "live" if setup["live"] else "unit")
        if _skip:
...
def _v1n2_direct_setup(mockres):
