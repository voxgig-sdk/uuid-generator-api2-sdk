...
class TestV3n2Direct:

    def test_should_direct_load_v3n2(self):
        setup = _v3n2_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-v3n2", "live" if setup["live"] else "unit")
        if _skip:
...
def _v3n2_direct_setup(mockres):
