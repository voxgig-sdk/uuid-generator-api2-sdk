# UuidGeneratorApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UuidGeneratorApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UuidGeneratorApi2SDK(...) and UuidGeneratorApi2SDK.test(...) become
#      UuidGeneratorApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "uuidgeneratorapi2_sdk"
_SDK_CLASS = "UuidGeneratorApi2SDK"
