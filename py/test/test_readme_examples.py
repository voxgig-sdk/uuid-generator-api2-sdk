# UuidGeneratorApi2 SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from uuidgeneratorapi2_sdk import UuidGeneratorApi2SDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"UuidGeneratorApi2SDK": UuidGeneratorApi2SDK, "os": os}
        try:
