...
class TestV7n2Direct:

    def test_should_direct_load_v7n2(self):
        setup = _v7n2_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-v7n2", "live" if setup["live"] else "unit")
        if _skip:
...
def _v7n2_direct_setup(mockres):
