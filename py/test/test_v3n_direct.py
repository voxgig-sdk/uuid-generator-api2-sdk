...
class TestV3nDirect:
    ...
    def test_should_direct_list_v3n(self):
        setup = _v3n_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-v3n", "live" if setup["live"] else "unit")
        if _skip:
