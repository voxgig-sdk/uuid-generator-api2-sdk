...
class TestV7nDirect:
    ...
    def test_should_direct_list_v7n(self):
        setup = _v7n_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-v7n", "live" if setup["live"] else "unit")
        if _skip:
