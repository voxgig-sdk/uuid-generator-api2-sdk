...
from uuidgeneratorapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class UuidGeneratorApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UuidGeneratorApi2Control()
        ...
        if isinstance(sp, UuidGeneratorApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UuidGeneratorApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UuidGeneratorApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return UuidGeneratorApi2Operation({})
    ...
    def make_error(self, code, msg):
        return UuidGeneratorApi2Error(code, msg, self)
