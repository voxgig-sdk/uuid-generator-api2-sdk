...
from uuidgeneratorapi2_sdk.utility import register

# Load features
from uuidgeneratorapi2_sdk.feature.base_feature import UuidGeneratorApi2BaseFeature
from uuidgeneratorapi2_sdk.features import _has_feature, _make_feature
...
class UuidGeneratorApi2SDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UuidGeneratorApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
