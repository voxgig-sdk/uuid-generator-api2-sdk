...
// UuidGeneratorApi2 SDK utility: result_basic

class UuidGeneratorApi2ResultBasic
{
    public static function call(UuidGeneratorApi2Context $ctx): ?UuidGeneratorApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UuidGeneratorApi2Error) ? $result->err->msg : (string)$result->err;
