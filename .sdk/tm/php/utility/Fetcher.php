...
// UuidGeneratorApi2 SDK utility: fetcher

class UuidGeneratorApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UuidGeneratorApi2SDK/1.0)';
    ...
    public static function call(UuidGeneratorApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
