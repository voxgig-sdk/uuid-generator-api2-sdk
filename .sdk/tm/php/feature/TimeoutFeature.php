...
// UuidGeneratorApi2 SDK timeout feature
...
class UuidGeneratorApi2TimeoutFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _with_timeout(UuidGeneratorApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UuidGeneratorApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
