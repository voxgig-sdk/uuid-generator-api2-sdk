...
// UuidGeneratorApi2 SDK cache feature
...
class UuidGeneratorApi2CacheFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _through(UuidGeneratorApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
