...
// UuidGeneratorApi2 SDK netsim feature
...
class UuidGeneratorApi2NetsimFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _simulate(UuidGeneratorApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UuidGeneratorApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
