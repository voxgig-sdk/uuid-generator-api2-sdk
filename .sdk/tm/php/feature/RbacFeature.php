...
// UuidGeneratorApi2 SDK rbac feature
...
class UuidGeneratorApi2RbacFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _required(UuidGeneratorApi2Context $ctx): ?string
    {
    ...
    private function _reject(UuidGeneratorApi2Context $ctx, string $required): void
    {
    ...
    private function _track(UuidGeneratorApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
