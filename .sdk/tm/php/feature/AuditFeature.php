...
// UuidGeneratorApi2 SDK audit feature
...
class UuidGeneratorApi2AuditFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _emit(UuidGeneratorApi2Context $ctx, string $outcome): void
    {
