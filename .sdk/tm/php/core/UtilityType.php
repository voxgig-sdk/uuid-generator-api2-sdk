...
// UuidGeneratorApi2 SDK utility type

class UuidGeneratorApi2Utility
{
    ...
    public static function copy(UuidGeneratorApi2Utility $src): UuidGeneratorApi2Utility
    {
        $u = new UuidGeneratorApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
