...
// UuidGeneratorApi2 SDK pipeline test
//
...
{
    private static function utility(): UuidGeneratorApi2Utility
    {
        return new UuidGeneratorApi2Utility();
    }
    ...
    private static function ctx(array $over = []): UuidGeneratorApi2Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UuidGeneratorApi2Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UuidGeneratorApi2Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UuidGeneratorApi2MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UuidGeneratorApi2MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UuidGeneratorApi2MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UuidGeneratorApi2Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UuidGeneratorApi2MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UuidGeneratorApi2Response([]),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        [, $err] = UuidGeneratorApi2MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec([]),
            'response' => null,
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        [, $err] = UuidGeneratorApi2MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec(['step' => 's']),
            'response' => new UuidGeneratorApi2Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        [, $err] = UuidGeneratorApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec(['step' => 's']),
            'response' => new UuidGeneratorApi2Response(self::resp(200, ['v' => 1])),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        [, $err] = UuidGeneratorApi2MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec(['step' => 's']),
            'response' => new UuidGeneratorApi2Response(self::resp(200, ['v' => 2])),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorApi2MakeResponse::call($ctx);
    ...
    {
        $preset = new UuidGeneratorApi2Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec([]),
            'response' => new UuidGeneratorApi2Response([]),
            'result' => new UuidGeneratorApi2Result([]),
        ...
        [$got, $err] = UuidGeneratorApi2MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UuidGeneratorApi2Result([])]);
        [, $err] = UuidGeneratorApi2MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UuidGeneratorApi2Spec([]), 'result' => null]);
        [, $err] = UuidGeneratorApi2MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UuidGeneratorApi2Spec(['step' => 's']),
            'result' => new UuidGeneratorApi2Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UuidGeneratorApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UuidGeneratorApi2Spec(['step' => 's']),
            'result' => new UuidGeneratorApi2Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UuidGeneratorApi2Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UuidGeneratorApi2MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UuidGeneratorApi2Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UuidGeneratorApi2Spec([]),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UuidGeneratorApi2MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UuidGeneratorApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UuidGeneratorApi2Error('boom', 'boom');
        $utility->fetcher = function (UuidGeneratorApi2Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UuidGeneratorApi2Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UuidGeneratorApi2MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UuidGeneratorApi2Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UuidGeneratorApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UuidGeneratorApi2Response::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorApi2MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UuidGeneratorApi2Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UuidGeneratorApi2Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UuidGeneratorApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UuidGeneratorApi2Response(self::resp(201));
        $ctx = self::ctx(['spec' => new UuidGeneratorApi2Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UuidGeneratorApi2MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UuidGeneratorApi2MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UuidGeneratorApi2MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UuidGeneratorApi2Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UuidGeneratorApi2Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UuidGeneratorApi2Result(['ok' => false])]);
        $this->expectException(UuidGeneratorApi2Error::class);
        UuidGeneratorApi2Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UuidGeneratorApi2Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UuidGeneratorApi2MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorApi2MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UuidGeneratorApi2BaseFeature();
        $b = new UuidGeneratorApi2BaseFeature();
        UuidGeneratorApi2FeatureAdd::call($ctx, $a);
        UuidGeneratorApi2FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UuidGeneratorApi2BaseFeature
    {
        $f = new UuidGeneratorApi2BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UuidGeneratorApi2FeatureAdd::call($ctx, self::named_feature('a'));
        UuidGeneratorApi2FeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        UuidGeneratorApi2FeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        UuidGeneratorApi2FeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        UuidGeneratorApi2FeatureAdd::call($ctx, $replace);
        ...
        UuidGeneratorApi2FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UuidGeneratorApi2Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UuidGeneratorApi2Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UuidGeneratorApi2PrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UuidGeneratorApi2PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UuidGeneratorApi2Response(['headers' => null]),
            'result' => new UuidGeneratorApi2Result([]),
        ]);
        UuidGeneratorApi2ResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UuidGeneratorApi2ResultBody::call($ctx);
