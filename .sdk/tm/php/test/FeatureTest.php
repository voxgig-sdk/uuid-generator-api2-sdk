...
// UuidGeneratorApi2 SDK feature test
//
...
class FtCtrl extends UuidGeneratorApi2Control
{
...
class FtClient
{
    ...
    private UuidGeneratorApi2Utility $utility;

    public function __construct(UuidGeneratorApi2Utility $utility, array $options)
    {
    ...
    public function get_utility(): UuidGeneratorApi2Utility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (UuidGeneratorApi2Context $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public UuidGeneratorApi2Context $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (UuidGeneratorApi2Context $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = UuidGeneratorApi2Config::make_feature($name);
    ...
    private static function buildUrl(UuidGeneratorApi2Spec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof UuidGeneratorApi2Error) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new UuidGeneratorApi2Response($fetched);
        }
    ...
    private function fail(UuidGeneratorApi2Context $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (UuidGeneratorApi2Context $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
