...
describe('exists', async () => {
  ...
  //
  // UuidGeneratorApi2SDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof UuidGeneratorApi2SDK, true,
      'UuidGeneratorApi2SDK.test() must return a client synchronously')
  })
