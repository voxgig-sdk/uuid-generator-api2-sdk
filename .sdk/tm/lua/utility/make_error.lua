...
local function make_error_util(ctx, err)
  ...
  local msg = "UuidGeneratorApi2SDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = UuidGeneratorApi2Error.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == UuidGeneratorApi2Error then
