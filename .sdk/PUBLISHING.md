...
|---|---|---|
| `ts/` | @voxgig-sdk/uuid-generator-api2-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/uuid-generator-api2-sdk \
      --repository voxgig-sdk/uuid-generator-api2-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/uuid-generator-api2-sdk` shows it, and
`npm trust revoke @voxgig-sdk/uuid-generator-api2-sdk --id=<id>` removes it.
