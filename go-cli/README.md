...
AQL-driven CLI and REPL for the UuidGeneratorApi2 SDK. Positional arguments are
...
```sh
go build -o uuid-generator-api2-cli ./...
```
...
./uuid-generator-api2-cli load 1 guid
./uuid-generator-api2-cli load '{id:1}' guid
