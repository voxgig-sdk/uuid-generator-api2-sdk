...
func registerSDKWords(r *eng.Registry, client *sdk.UuidGeneratorApi2SDK) {
...
func runOp(client *sdk.UuidGeneratorApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
