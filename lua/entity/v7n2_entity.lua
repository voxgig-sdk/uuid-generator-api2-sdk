...
local V7n2Entity = {}
V7n2Entity.__index = V7n2Entity


function V7n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V7n2Entity)
  self._name = "v7n2"
  self._client = client
...
function V7n2Entity:get_name()
  return self._name
end


function V7n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V7n2Entity.new(self._client, opts)
end


function V7n2Entity:data_set(args)
  if args ~= nil then
...
function V7n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V7n2Entity:match_set(args)
  if args ~= nil then
...
function V7n2Entity:stream(action, args, callopts)
...
---@param reqmatch V7n2LoadMatch
---@param ctrl? table
---@return V7n2
---@return string? err
function V7n2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function V7n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
