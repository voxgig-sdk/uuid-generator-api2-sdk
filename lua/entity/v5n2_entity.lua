...
local V5n2Entity = {}
V5n2Entity.__index = V5n2Entity


function V5n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V5n2Entity)
  self._name = "v5n2"
  self._client = client
...
function V5n2Entity:get_name()
  return self._name
end


function V5n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V5n2Entity.new(self._client, opts)
end


function V5n2Entity:data_set(args)
  if args ~= nil then
...
function V5n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V5n2Entity:match_set(args)
  if args ~= nil then
...
function V5n2Entity:stream(action, args, callopts)
...
---@param reqmatch V5n2LoadMatch
---@param ctrl? table
---@return V5n2
---@return string? err
function V5n2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function V5n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
