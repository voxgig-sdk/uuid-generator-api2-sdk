...
local V4n2Entity = {}
V4n2Entity.__index = V4n2Entity


function V4n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V4n2Entity)
  self._name = "v4n2"
  self._client = client
...
function V4n2Entity:get_name()
  return self._name
end


function V4n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V4n2Entity.new(self._client, opts)
end


function V4n2Entity:data_set(args)
  if args ~= nil then
...
function V4n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V4n2Entity:match_set(args)
  if args ~= nil then
...
function V4n2Entity:stream(action, args, callopts)
...
function V4n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
