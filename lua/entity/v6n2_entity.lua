...
local V6n2Entity = {}
V6n2Entity.__index = V6n2Entity


function V6n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V6n2Entity)
  self._name = "v6n2"
  self._client = client
...
function V6n2Entity:get_name()
  return self._name
end


function V6n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V6n2Entity.new(self._client, opts)
end


function V6n2Entity:data_set(args)
  if args ~= nil then
...
function V6n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V6n2Entity:match_set(args)
  if args ~= nil then
...
function V6n2Entity:stream(action, args, callopts)
...
function V6n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
