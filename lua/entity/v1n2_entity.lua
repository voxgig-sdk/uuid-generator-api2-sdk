...
local V1n2Entity = {}
V1n2Entity.__index = V1n2Entity


function V1n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V1n2Entity)
  self._name = "v1n2"
  self._client = client
...
function V1n2Entity:get_name()
  return self._name
end


function V1n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V1n2Entity.new(self._client, opts)
end


function V1n2Entity:data_set(args)
  if args ~= nil then
...
function V1n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V1n2Entity:match_set(args)
  if args ~= nil then
...
function V1n2Entity:stream(action, args, callopts)
...
---@param reqmatch V1n2LoadMatch
---@param ctrl? table
---@return V1n2
---@return string? err
function V1n2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function V1n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
