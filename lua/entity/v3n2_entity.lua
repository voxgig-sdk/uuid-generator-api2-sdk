...
local V3n2Entity = {}
V3n2Entity.__index = V3n2Entity


function V3n2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, V3n2Entity)
  self._name = "v3n2"
  self._client = client
...
function V3n2Entity:get_name()
  return self._name
end


function V3n2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return V3n2Entity.new(self._client, opts)
end


function V3n2Entity:data_set(args)
  if args ~= nil then
...
function V3n2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function V3n2Entity:match_set(args)
  if args ~= nil then
...
function V3n2Entity:stream(action, args, callopts)
...
---@param reqmatch V3n2LoadMatch
---@param ctrl? table
---@return V3n2
---@return string? err
function V3n2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function V3n2Entity:_run_op(ctx, post_done)
  local utility = self._utility
