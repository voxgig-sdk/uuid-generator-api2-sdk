...
describe("V3nDirect", function()
  it("should direct-list-v3n", function()
    local setup = v3n_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-v3n", setup.live and "live" or "unit")
