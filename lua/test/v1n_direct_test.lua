...
describe("V1nDirect", function()
  it("should direct-list-v1n", function()
    local setup = v1n_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-v1n", setup.live and "live" or "unit")
