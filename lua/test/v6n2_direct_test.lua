...
describe("V6n2Direct", function()
  it("should direct-load-v6n2", function()
    local setup = v6n2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v6n2", setup.live and "live" or "unit")
