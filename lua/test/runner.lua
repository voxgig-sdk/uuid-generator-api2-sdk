...
function runner.env_override(m)
  local live = runner.getenv("UUIDGENERATORAPI2_TEST_LIVE")
  local override = runner.getenv("UUIDGENERATORAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UUIDGENERATORAPI2_TEST_EXPLAIN")
