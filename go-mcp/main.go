// Command UuidGeneratorApi2-mcp is an MCP server exposing the UuidGeneratorApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UuidGeneratorApi2_list  — list records of an entity
//	UuidGeneratorApi2_load  — load a single record of an entity
//
