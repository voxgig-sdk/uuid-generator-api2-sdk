...
func (e *V5nEntity) Make() core.Entity {
	...
	return NewV5nEntity(e.client, opts)
}

func (e *V5nEntity) Data(args ...any) any {
...
func (e *V5nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V5n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V5nEntity) DataTyped(data ...V5n) V5n {
	if len(data) > 0 {
		return typedFrom[V5n](e.Data(asMap(data[0])))
	}
	return typedFrom[V5n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V5n (all fields
// optional at the wire level).
func (e *V5nEntity) MatchTyped(match ...V5n) V5n {
	if len(match) > 0 {
		return typedFrom[V5n](e.Match(asMap(match[0])))
	}
	return typedFrom[V5n](e.Match())
}
...
func (e *V5nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V5nEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V5nListMatch and returns []V5n. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *V5nEntity) ListTyped(reqmatch V5nListMatch, ctrl map[string]any) ([]V5n, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[V5n](res), nil
}



func (e *V5nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V5nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V5nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V5nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
