...
func (e *V6nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V6nEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V6nLoadMatch and returns an V6n. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V6nEntity) LoadTyped(reqmatch V6nLoadMatch, ctrl map[string]any) (V6n, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V6n{}, err
	}
	return typedFrom[V6n](res), nil
}
