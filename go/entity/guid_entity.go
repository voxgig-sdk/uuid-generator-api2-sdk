...
func NewGuidEntity(client *core.UuidGeneratorApi2SDK, entopts map[string]any) *GuidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GuidEntity) GetName() string { return e.name }
...
func (e *GuidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GuidEntity) Deleted() bool {
	return e.deleted
}


func (e *GuidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGuidEntity(e.client, opts)
}

func (e *GuidEntity) Data(args ...any) any {
...
func (e *GuidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Guid; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GuidEntity) DataTyped(data ...Guid) Guid {
	if len(data) > 0 {
		return typedFrom[Guid](e.Data(asMap(data[0])))
	}
	return typedFrom[Guid](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Guid (all fields
// optional at the wire level).
func (e *GuidEntity) MatchTyped(match ...Guid) Guid {
	if len(match) > 0 {
		return typedFrom[Guid](e.Match(asMap(match[0])))
	}
	return typedFrom[Guid](e.Match())
}
...
func (e *GuidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GuidEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GuidLoadMatch and returns an Guid. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GuidEntity) LoadTyped(reqmatch GuidLoadMatch, ctrl map[string]any) (Guid, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Guid{}, err
	}
	return typedFrom[Guid](res), nil
}




func (e *GuidEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GuidListMatch and returns []Guid. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GuidEntity) ListTyped(reqmatch GuidListMatch, ctrl map[string]any) ([]Guid, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Guid](res), nil
}



func (e *GuidEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GuidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GuidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GuidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
