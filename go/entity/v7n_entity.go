...
func NewV7nEntity(client *core.UuidGeneratorApi2SDK, entopts map[string]any) *V7nEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V7nEntity) GetName() string { return e.name }
...
func (e *V7nEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V7nEntity) Deleted() bool {
	return e.deleted
}


func (e *V7nEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV7nEntity(e.client, opts)
}

func (e *V7nEntity) Data(args ...any) any {
...
func (e *V7nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V7n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V7nEntity) DataTyped(data ...V7n) V7n {
	if len(data) > 0 {
		return typedFrom[V7n](e.Data(asMap(data[0])))
	}
	return typedFrom[V7n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V7n (all fields
// optional at the wire level).
func (e *V7nEntity) MatchTyped(match ...V7n) V7n {
	if len(match) > 0 {
		return typedFrom[V7n](e.Match(asMap(match[0])))
	}
	return typedFrom[V7n](e.Match())
}
...
func (e *V7nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V7nEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V7nLoadMatch and returns an V7n. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V7nEntity) LoadTyped(reqmatch V7nLoadMatch, ctrl map[string]any) (V7n, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V7n{}, err
	}
	return typedFrom[V7n](res), nil
}




func (e *V7nEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// V7nListMatch and returns []V7n. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *V7nEntity) ListTyped(reqmatch V7nListMatch, ctrl map[string]any) ([]V7n, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[V7n](res), nil
}



func (e *V7nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V7nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V7nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V7nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
