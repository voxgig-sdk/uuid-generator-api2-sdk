...
func NewV4nEntity(client *core.UuidGeneratorApi2SDK, entopts map[string]any) *V4nEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V4nEntity) GetName() string { return e.name }
...
func (e *V4nEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V4nEntity) Deleted() bool {
	return e.deleted
}


func (e *V4nEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV4nEntity(e.client, opts)
}

func (e *V4nEntity) Data(args ...any) any {
...
func (e *V4nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V4n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V4nEntity) DataTyped(data ...V4n) V4n {
	if len(data) > 0 {
		return typedFrom[V4n](e.Data(asMap(data[0])))
	}
	return typedFrom[V4n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V4n (all fields
// optional at the wire level).
func (e *V4nEntity) MatchTyped(match ...V4n) V4n {
	if len(match) > 0 {
		return typedFrom[V4n](e.Match(asMap(match[0])))
	}
	return typedFrom[V4n](e.Match())
}
...
func (e *V4nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V4nEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V4nLoadMatch and returns an V4n. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V4nEntity) LoadTyped(reqmatch V4nLoadMatch, ctrl map[string]any) (V4n, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V4n{}, err
	}
	return typedFrom[V4n](res), nil
}




func (e *V4nEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// V4nListMatch and returns []V4n. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *V4nEntity) ListTyped(reqmatch V4nListMatch, ctrl map[string]any) ([]V4n, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[V4n](res), nil
}



func (e *V4nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V4nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V4nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V4nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
