...
## Install
```bash
go get github.com/voxgig-sdk/uuid-generator-api2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/uuid-generator-api2-sdk=../path/to/github.com/voxgig-sdk/uuid-generator-api2-sdk
```
...
```
github.com/voxgig-sdk/uuid-generator-api2-sdk/
...
The root package (`github.com/voxgig-sdk/uuid-generator-api2-sdk`) re-exports everything needed
