...
const testSeed = `map[string]any{"entity": map[string]any{"guid": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v1n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v1n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v3n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v3n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v4n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v4n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v5n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v5n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v6n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v6n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v7n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v7n2": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
