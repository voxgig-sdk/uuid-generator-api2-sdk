...
func TestV3nEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		v3nRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.v3n")))
...
func v3nBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("UUID_GENERATOR_API2_TEST_V3N_ENTID")
	...
	idmapResolved := core.ToMapAny(env["UUID_GENERATOR_API2_TEST_V3N_ENTID"])
