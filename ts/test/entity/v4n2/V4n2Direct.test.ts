...
describe('V4n2Direct', async () => {
  ...
  test('direct-load-v4n2', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-v4n2', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['UUIDGENERATORAPI__TEST_V_N__ENTID']
