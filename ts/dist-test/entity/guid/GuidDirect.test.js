...
(0, node_test_1.describe)('GuidDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-guid', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-guid', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-guid', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-guid', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_API2_TEST_GUID_ENTID'];
...
//# sourceMappingURL=GuidDirect.test.js.map