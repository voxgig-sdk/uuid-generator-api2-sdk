...
(0, node_test_1.describe)('V6nEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'v6n.' + op, live))
                return;
        }
        ...
        let v6n_ref01_data = Object.values(setup.data.existing.v6n)[0];
        // LIST
        const v6n_ref01_ent = client.V6n();
        const v6n_ref01_match = {};
        const v6n_ref01_list = (await v6n_ref01_ent.list(v6n_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/v6n/V6nTestData.json');
    ...
    let idmap = transform(['v6n01', 'v6n02', 'v6n03', 'v601', 'v602', 'v603'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=V6nEntity.test.js.map