...
(0, node_test_1.describe)('V4nDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-v4n', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v4n', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-v4n', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-v4n', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UuidGeneratorApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['UUID_GENERATOR_API2_TEST_V4N_ENTID'];
...
//# sourceMappingURL=V4nDirect.test.js.map