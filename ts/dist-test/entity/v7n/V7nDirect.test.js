...
(0, node_test_1.describe)('V7nDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-v7n', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v7n', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-v7n', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-v7n', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_API2_TEST_V7N_ENTID'];
...
//# sourceMappingURL=V7nDirect.test.js.map