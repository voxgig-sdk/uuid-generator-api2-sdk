...
(0, node_test_1.describe)('V7nEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'v7n.' + op, live))
                return;
        }
        ...
        let v7n_ref01_data = Object.values(setup.data.existing.v7n)[0];
        // LIST
        const v7n_ref01_ent = client.V7n();
        const v7n_ref01_match = {};
        const v7n_ref01_list = (await v7n_ref01_ent.list(v7n_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/v7n/V7nTestData.json');
    ...
    let idmap = transform(['v7n01', 'v7n02', 'v7n03', 'v701', 'v702', 'v703'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=V7nEntity.test.js.map