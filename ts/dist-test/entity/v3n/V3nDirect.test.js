...
(0, node_test_1.describe)('V3nDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-v3n', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v3n', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-v3n', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-v3n', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'UUID_GENERATOR_API2_TEST_V3N_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_API2_TEST_V3N_ENTID'];
...
//# sourceMappingURL=V3nDirect.test.js.map