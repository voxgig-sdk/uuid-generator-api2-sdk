...
function envOverride(m) {
    if ('TRUE' === process.env.UUID_GENERATOR_API2_TEST_LIVE ||
        'TRUE' === process.env.UUID_GENERATOR_API2_TEST_OVERRIDE) {
    ...
    m.UUID_GENERATOR_API2_TEST_EXPLAIN = process.env.UUID_GENERATOR_API2_TEST_EXPLAIN || m.UUID_GENERATOR_API2_TEST_EXPLAIN;
    return m;
}
