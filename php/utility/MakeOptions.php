...
// UuidGeneratorApi2 SDK utility: make_options

class UuidGeneratorApi2MakeOptions
{
    ...
    public static function call(UuidGeneratorApi2Context $ctx): array
    {
        ...
        //
        // `UuidGeneratorApi2Schema::optspec()` is built from the model:
        ...
        $optspec = UuidGeneratorApi2Schema::optspec();
