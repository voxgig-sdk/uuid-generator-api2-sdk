...
// UuidGeneratorApi2 SDK utility: graphql
//
...
class UuidGeneratorApi2Graphql
{
    ...
    // equivalent.
    public static function body(UuidGeneratorApi2Context $ctx): mixed
    {
    ...
    public static function errors(UuidGeneratorApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
