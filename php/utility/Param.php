...
// UuidGeneratorApi2 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class UuidGeneratorApi2Param
{
    public static function call(UuidGeneratorApi2Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = UuidGeneratorApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
