...
// UuidGeneratorApi2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UuidGeneratorApi2TransformResponse
{
    public static function call(UuidGeneratorApi2Context $ctx): mixed
    {
        ...
        $transform = UuidGeneratorApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
