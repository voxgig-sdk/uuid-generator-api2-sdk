...
// UuidGeneratorApi2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UuidGeneratorApi2MakeRequest
{
    public static function call(UuidGeneratorApi2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UuidGeneratorApi2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UuidGeneratorApi2Response($fetched);
        } else {
