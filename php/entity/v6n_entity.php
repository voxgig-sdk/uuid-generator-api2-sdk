...
// UuidGeneratorApi2 SDK V6n entity
...
class V6nEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V6nEntity($this->_client, $opts);
    }

    /**
     * @param V6n|array $args V6n data (assoc-array) to store.
     */
    ...
    /**
     * @return V6n|array The current V6n data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V6n fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V6n fields).
     */
     ...
     * Load a single V6n.
     *
     * @param V6nLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V6nLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V6n|array The loaded V6n as an assoc-array at the
    ...
    /**
     * List V6n items matching the given filter.
     *
     * @param V6nListMatch|array|null $reqmatch Match filter (any subset
     *   of V6n fields) as an assoc-array; V6nListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V6n[]|array A list of V6n items as assoc-arrays at
