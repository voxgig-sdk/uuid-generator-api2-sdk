...
// UuidGeneratorApi2 SDK V1n2 entity
...
class V1n2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new V1n2Entity($this->_client, $opts);
    }

    /**
     * @param V1n2|array $args V1n2 data (assoc-array) to store.
     */
    ...
    /**
     * @return V1n2|array The current V1n2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V1n2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V1n2 fields).
     */
     ...
     * Load a single V1n2.
     *
     * @param V1n2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V1n2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V1n2|array The loaded V1n2 as an assoc-array at the
