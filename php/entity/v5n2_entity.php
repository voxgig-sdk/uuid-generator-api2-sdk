...
// UuidGeneratorApi2 SDK V5n2 entity
...
class V5n2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new V5n2Entity($this->_client, $opts);
    }

    /**
     * @param V5n2|array $args V5n2 data (assoc-array) to store.
     */
    ...
    /**
     * @return V5n2|array The current V5n2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V5n2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V5n2 fields).
     */
     ...
     * Load a single V5n2.
     *
     * @param V5n2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V5n2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V5n2|array The loaded V5n2 as an assoc-array at the
