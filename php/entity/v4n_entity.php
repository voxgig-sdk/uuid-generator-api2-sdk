...
class V4nEntity
{
     ...
     * Load a single V4n.
     *
     * @param V4nLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V4nLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V4n|array The loaded V4n as an assoc-array at the
