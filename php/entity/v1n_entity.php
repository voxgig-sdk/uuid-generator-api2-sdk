...
class V1nEntity
{
     ...
     *
     * @param V1nListMatch|array|null $reqmatch Match filter (any subset
     *   of V1n fields) as an assoc-array; V1nListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V1n[]|array A list of V1n items as assoc-arrays at
