...
// UuidGeneratorApi2 SDK V3n2 entity
...
class V3n2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new V3n2Entity($this->_client, $opts);
    }

    /**
     * @param V3n2|array $args V3n2 data (assoc-array) to store.
     */
    ...
    /**
     * @return V3n2|array The current V3n2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V3n2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V3n2 fields).
     */
     ...
     * Load a single V3n2.
     *
     * @param V3n2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V3n2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V3n2|array The loaded V3n2 as an assoc-array at the
