...
// UuidGeneratorApi2 SDK V6n2 entity
...
class V6n2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new V6n2Entity($this->_client, $opts);
    }

    /**
     * @param V6n2|array $args V6n2 data (assoc-array) to store.
     */
    ...
    /**
     * @return V6n2|array The current V6n2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V6n2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V6n2 fields).
     */
     ...
     * Load a single V6n2.
     *
     * @param V6n2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V6n2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V6n2|array The loaded V6n2 as an assoc-array at the
