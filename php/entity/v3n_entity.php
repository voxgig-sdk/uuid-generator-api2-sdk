...
class V3nEntity
{
     ...
     *
     * @param V3nListMatch|array|null $reqmatch Match filter (any subset
     *   of V3n fields) as an assoc-array; V3nListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V3n[]|array A list of V3n items as assoc-arrays at
