...
class V5n2DirectTest extends TestCase
{
    public function test_direct_load_v5n2(): void
    {
        $setup = v5n2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v5n2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function v5n2_direct_setup($mockres)
{
