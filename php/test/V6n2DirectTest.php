...
class V6n2DirectTest extends TestCase
{
    public function test_direct_load_v6n2(): void
    {
        $setup = v6n2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v6n2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function v6n2_direct_setup($mockres)
{
