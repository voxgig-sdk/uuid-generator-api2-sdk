...
class V4n2DirectTest extends TestCase
{
    public function test_direct_load_v4n2(): void
    {
        $setup = v4n2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v4n2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function v4n2_direct_setup($mockres)
{
