...
// UuidGeneratorApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UuidGeneratorApi2SDK::test)
...
{
    private const SDK_CLASS = 'UuidGeneratorApi2SDK';
    ...
    private const SDK_BASE = 'uuidgeneratorapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../uuidgeneratorapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
