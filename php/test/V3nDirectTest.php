...
{
    public function test_direct_list_v3n(): void
    {
        $setup = v3n_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-v3n", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
