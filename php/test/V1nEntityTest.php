...
class V1nEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->V1n(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->V1n(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set UUID_GENERATOR_API2_TEST_V1N_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $v1n_ref01_list_result = $v1n_ref01_ent->list($v1n_ref01_match, null);
        $this->assertIsArray($v1n_ref01_list_result);
...
function v1n_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("UUID_GENERATOR_API2_TEST_V1N_ENTID");
