...
// UuidGeneratorApi2 SDK proxy feature
...
class UuidGeneratorApi2ProxyFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    public function init(UuidGeneratorApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UuidGeneratorApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
