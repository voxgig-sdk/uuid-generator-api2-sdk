...
// UuidGeneratorApi2 SDK clienttrack feature
...
class UuidGeneratorApi2ClienttrackFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    public function PostConstruct(UuidGeneratorApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UuidGeneratorApi2-SDK';
