...
// UuidGeneratorApi2 SDK debug feature
...
class UuidGeneratorApi2DebugFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _finish(UuidGeneratorApi2Context $ctx, bool $ok): void
    {
