...
// UuidGeneratorApi2 SDK streaming feature
...
class UuidGeneratorApi2StreamingFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _iterate(UuidGeneratorApi2Result $result): \Generator
    {
    ...
    private function _streamable(UuidGeneratorApi2Context $ctx): bool
    {
