...
// UuidGeneratorApi2 SDK idempotency feature
...
class UuidGeneratorApi2IdempotencyFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _mutating(UuidGeneratorApi2Context $ctx): bool
    {
