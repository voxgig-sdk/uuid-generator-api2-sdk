...
// UuidGeneratorApi2 SDK telemetry feature
...
class UuidGeneratorApi2TelemetryFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _close(UuidGeneratorApi2Context $ctx, bool $ok): void
    {
