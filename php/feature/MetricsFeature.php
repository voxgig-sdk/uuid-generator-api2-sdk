...
// UuidGeneratorApi2 SDK metrics feature
...
class UuidGeneratorApi2MetricsFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _record(UuidGeneratorApi2Context $ctx, bool $ok): void
    {
