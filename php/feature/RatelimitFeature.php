...
// UuidGeneratorApi2 SDK ratelimit feature
...
class UuidGeneratorApi2RatelimitFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    private function _acquire(UuidGeneratorApi2Context $ctx): void
    {
    ...
    private function _track(UuidGeneratorApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
