...
// UuidGeneratorApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UuidGeneratorApi2TestFeature extends UuidGeneratorApi2BaseFeature
{
    ...
    public function init(UuidGeneratorApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UuidGeneratorApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UuidGeneratorApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UuidGeneratorApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UuidGeneratorApi2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = UuidGeneratorApi2Param::call($ctx, $k);
