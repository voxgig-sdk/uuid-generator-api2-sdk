# UuidGeneratorApi2 SDK V4n entity
...
class V4nEntity
  ...
  # @return [V4n, Hash] the current V4n data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of V4n fields)
  def match_get
  ...
  # Load a single V4n.
  #
  # @param reqmatch [V4nLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.V4n.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [V4n, Hash] the loaded V4n; raises UuidGeneratorApi2Error on failure
  ...
  #
  # @param reqmatch [V4nListMatch, Hash, nil] match filter (any subset of
  #   V4n fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<V4n>, Array] the matching V4n items; raises UuidGeneratorApi2Error on failure
