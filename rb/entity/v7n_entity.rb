...
class V7nEntity
  ...
  # Load a single V7n.
  #
  # @param reqmatch [V7nLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.V7n.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [V7n, Hash] the loaded V7n; raises UuidGeneratorApi2Error on failure
  ...
  #
  # @param reqmatch [V7nListMatch, Hash, nil] match filter (any subset of
  #   V7n fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
