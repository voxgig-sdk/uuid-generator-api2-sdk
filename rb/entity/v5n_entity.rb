...
class V5nEntity
  ...
  # @return [V5n, Hash] the current V5n data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of V5n fields)
  def match_get
  ...
  # Load a single V5n.
  #
  # @param reqmatch [V5nLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.V5n.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [V5n, Hash] the loaded V5n; raises UuidGeneratorApi2Error on failure
  ...
  #
  # @param reqmatch [V5nListMatch, Hash, nil] match filter (any subset of
  #   V5n fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<V5n>, Array] the matching V5n items; raises UuidGeneratorApi2Error on failure
