# UuidGeneratorApi2 SDK V1n entity
...
class V1nEntity
  ...
  # @return [V1n, Hash] the loaded V1n; raises UuidGeneratorApi2Error on failure
  ...
  # List V1n items matching the given filter.
  #
  # @param reqmatch [V1nListMatch, Hash, nil] match filter (any subset of
  #   V1n fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<V1n>, Array] the matching V1n items; raises UuidGeneratorApi2Error on failure
