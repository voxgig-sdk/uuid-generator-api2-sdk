# UuidGeneratorApi2 SDK V3n entity
...
class V3nEntity
  ...
  # @return [V3n, Hash] the loaded V3n; raises UuidGeneratorApi2Error on failure
  ...
  # List V3n items matching the given filter.
  #
  # @param reqmatch [V3nListMatch, Hash, nil] match filter (any subset of
  #   V3n fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<V3n>, Array] the matching V3n items; raises UuidGeneratorApi2Error on failure
