...
class V3n2Entity
  ...
  # @return [V3n2, Hash] the current V3n2 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of V3n2 fields)
  def match_get
  ...
  # Load a single V3n2.
  #
  # @param reqmatch [V3n2LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.V3n2.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [V3n2, Hash] the loaded V3n2; raises UuidGeneratorApi2Error on failure
