...
class V7n2DirectTest < Minitest::Test
  def test_direct_load_v7n2
    setup = v7n2_direct_setup({ "id" => "direct01" })
    _should_skip, _reason = Runner.is_control_skipped("direct", "direct-load-v7n2", setup[:live] ? "live" : "unit")
    if _should_skip
