...
class GuidEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set UUIDGENERATORAPI__TEST_GUID_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def guid_basic_setup(extra)
  ...
  entid_env_raw = ENV["UUIDGENERATORAPI__TEST_GUID_ENTID"]
