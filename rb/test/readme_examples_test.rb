...
#      offline in seeded test mode (UuidGeneratorApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UuidGeneratorApi2_sdk.rb")
  SDK_CLASS = "UuidGeneratorApi2SDK"
  ...
  SDK_BASE = "UuidGeneratorApi2_sdk"
