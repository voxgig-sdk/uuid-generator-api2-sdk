...
class V3n2EntityTest < Minitest::Test
  ...
  def test_basic_flow
    setup = v3n2_basic_setup(nil)
    # Per-op sdk-test-control.json skip.
    _live = setup[:live] || false
    ["load"].each do |_op|
      _should_skip, _reason = Runner.is_control_skipped("entityOp", "v3n2." + _op, _live ? "live" : "unit")
      if _should_skip
    ...
    v3n2_ref01_data = nil
    if v3n2_ref01_data_raw.length > 0
      v3n2_ref01_data = Helpers.to_map(v3n2_ref01_data_raw[0][1])
    end

    # LOAD
    v3n2_ref01_ent = client.V3n2(nil)
    v3n2_ref01_match_dt0 = {}
    v3n2_ref01_data_dt0_loaded, err = v3n2_ref01_ent.load(v3n2_ref01_match_dt0, nil)
    assert_nil err
    assert !v3n2_ref01_data_dt0_loaded.nil?

  end
end

def v3n2_basic_setup(extra)
  Runner.load_env_local

  entity_data_file = File.join(__dir__, "..", "..", ".sdk", "test", "entity", "v3n2", "V3n2TestData.json")
